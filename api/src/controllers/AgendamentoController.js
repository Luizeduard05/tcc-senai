...
const agendamentoController = {
    ...
    async editarAgendamento(req, res) {
        ...
        console.log('data_e_hora recebida:', data_e_hora);  // Log para verificar a entrada
        ...
        // Formata a data antes de passar para o banco de dados
        const agendamento = new classAgendamento({
            data_e_hora: data_e_hora,  // Passa a data diretamente
            id: idAge, 
            observacao, 
            id_os // Inclui o id_os que foi passado
        });
