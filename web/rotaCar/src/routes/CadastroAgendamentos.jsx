...
const CadastroAgendamento = () => {
    ...
    return (
        <>
        <Header/>
            <div className={stylesAgendarCad.principal}>
                ...
                >
                    ...
                    >
                        ...
                        <div className={stylesAgendarCad.inputGroup}>
                            ...
                            >
                                {nomePessoa || 'Clique Para Selecionar Um Cliente'}
                            </button>
                        </div>
                    ...
                    >
                        ...
                        <button onClick={() => setIsModalOpen(false)} className={stylesAgendarCad.closeButton1}>
                            ✕
                        </button>
